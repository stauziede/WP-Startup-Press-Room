...
class PR_Post_Type_Metaboxes {
	public function init() {
		add_action( 'add_meta_boxes', array( $this, 'pr_meta_boxes' ) );
		...
		<table class="form-table">
			...
			<tr>
				<td class="team_meta_box_td" colspan="2">
					<label for="profile_title"><?php _e( 'Title', 'pr-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
					<input type="text" name="profile_title" class="regular-text" value="<?php echo $title; ?>">
					<p class="description"><?php _e( 'E.g. CEO, Sales Lead, Designer', 'pr-post-type' ); ?></p>
				</td>
			</tr>

			<tr>
				<td class="team_meta_box_td" colspan="2">
					<label for="profile_linkedin"><?php _e( 'LinkedIn URL', 'pr-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="team_meta_box_td" colspan="2">
					<label for="profile_twitter"><?php _e( 'Twitter URL', 'pr-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="team_meta_box_td" colspan="2">
					<label for="profile_facebook"><?php _e( 'Facebook URL', 'pr-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
